...
/**
 * Detector for HasOne relationships.
 */
class HasOneDetector
{
    ...
    /**
     * Detect HasOne relationships for a table.
     *
    ...
    public function detect(string $table): array
    {
        ...
        try
        {
            ...
            foreach ($tables as $relatedTable)
            {
                ...
                {
                    if ($this->isHasOneRelationship($table, $index))
                    {
    ...
    /**
     * Check if an index represents a HasOne relationship.
     *
     * @param string $table The table name
     * @param IndexDefinition $index The index to check
     */
    private function isHasOneRelationship(string $table, IndexDefinition $index): bool
    {
    ...
    /**
     * Create a HasOne relationship definition.
     *
     * @param string $table The table name
    ...
    private function createRelationship(
        ...
        return new RelationshipDefinition(
            type: RelationshipDefinition::TYPE_HAS_ONE,
