...
class Container_8569a29d84 extends _PHPStan_d5312c05b\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_8569a29d84 $container)
			{
	...
	public function createServiceContainer(): Container_8569a29d84
	{
		return $this;
	}
