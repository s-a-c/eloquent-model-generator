...
class Container_59f125fbda extends _PHPStan_d5312c05b\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_59f125fbda $container)
			{
	...
	public function createServiceContainer(): Container_59f125fbda
	{
		return $this;
	}
