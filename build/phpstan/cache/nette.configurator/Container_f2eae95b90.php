...
class Container_f2eae95b90 extends _PHPStan_d5312c05b\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f2eae95b90 $container)
			{
	...
	public function createServiceContainer(): Container_f2eae95b90
	{
		return $this;
	}
