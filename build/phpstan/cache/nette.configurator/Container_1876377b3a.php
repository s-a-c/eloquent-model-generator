...
class Container_1876377b3a extends _PHPStan_d25a815b1\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_1876377b3a $container)
			{
	...
	public function createServiceContainer(): Container_1876377b3a
	{
		return $this;
	}
