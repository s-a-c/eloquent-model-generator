...
// source: phar:///Users/s-a-c/Herd/laravel-package-dev/packages/StandAlonecomplex/EloquentModelGenerator/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
...
class Container_7bea9be492 extends _PHPStan_d5312c05b\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				'#Call to static method factory\(\) on an unknown class [a-zA-Z0-9\\\_]+#',
			],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7bea9be492 $container)
			{
	...
	public function createService066(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar:///Users/s-a-c/Herd/laravel-package-dev/packages/StandAlonecomplex/EloquentModelGenerator/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///Users/s-a-c/Herd/laravel-package-dev/packages/StandAlonecomplex/EloquentModelGenerator/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///Users/s-a-c/Herd/laravel-package-dev/packages/StandAlonecomplex/EloquentModelGenerator/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///Users/s-a-c/Herd/laravel-package-dev/packages/StandAlonecomplex/EloquentModelGenerator/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
	...
	{
		return new PHPStan\Reflection\Mixin\MixinMethodsClassReflectionExtension(['Eloquent', 'Eloquent']);
	}


	public function createService0106(): PHPStan\Reflection\Mixin\MixinPropertiesClassReflectionExtension
	{
		return new PHPStan\Reflection\Mixin\MixinPropertiesClassReflectionExtension(['Eloquent', 'Eloquent']);
	}
	...
	{
		return new Larastan\Larastan\Properties\SquashedMigrationHelper([], $this->getService('081'), $this->getService('0562'), true);
	}
	...
	public function createServiceContainer(): Container_7bea9be492
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'mixinExcludeClasses' => ['Eloquent', 'Eloquent'],
			'scanFiles' => [],
			'scanDirectories' => [],
			'parallel' => [
				'jobSize' => 20,
			...
			'earlyTerminatingFunctionCalls' => ['abort', 'dd', 'abort', 'dd', 'dump'],
			...
			'larastan' => [
				'parallel' => ['maximumNumberOfProcesses' => 4, 'jobSize' => 20],
				'checkModelActionsAreReturnTypeDeclarations' => true,
				'checkModelRules' => true,
				'checkMigrations' => false,
				'checkFunctionNamespaces' => true,
